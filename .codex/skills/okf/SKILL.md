---
name: okf
description: Create, validate, consume, and interview-to-build Open Knowledge Format (OKF v0.1) bundles represented as Markdown with YAML frontmatter. Use when building OKF bundles, auditing OKF conformance, generating index.md or log.md files, navigating an OKF bundle, or interviewing a user to document personal knowledge as OKF concepts.
metadata:
  short-description: Work with Open Knowledge Format bundles
---
